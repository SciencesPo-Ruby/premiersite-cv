...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { date_debut: @education.date_debut, date_fin: @education.date_fin, description: @education.description, institution: @education.institution, lieu: @education.lieu, titre: @education.titre } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { date_debut: @education.date_debut, date_fin: @education.date_fin, description: @education.description, institution: @education.institution, lieu: @education.lieu, titre: @education.titre } }
